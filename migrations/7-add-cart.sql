...
INSERT INTO `resource` (`resource_id`) VALUES ('Front:Cart');
INSERT INTO `permission` (`permission_id`, `role_id`, `resource_id`, `action`, `type`) VALUES (NULL, 'guest', 'Front:Cart', '', 'allow'), (NULL, 'authenticated', 'Front:Cart', '', 'allow'), (NULL, 'admin', 'Front:Cart', '', 'allow');
COMMIT;